<template name="Content">
  ...
  <img src="/logo.png" />
    ...
    <div class="inner">
      <div class="breif">
        <p>SpaceTalk makes it easy to launch your very own chat application, and get in control of your data. Build and customize your very own <em>Telegram</em>, or <em>Facebook Messenger</em>!</p>
